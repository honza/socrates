...
This is a modified version of the original markdown script.
It parses <code> with Pygments.
...
class Markdown(object):
    ...
    def _code_block_sub(self, match):
        ...
        """
        Patch built-in <code><pre> processing to use pygments
        Syntaxt highlighting


        In Markdown, you need to specify what language your code is in. 
        E.g.
        ...
        p = codeblock.index('\n')
        t = codeblock[:p]
        codeblock = codeblock[(p + 1):]
        lexer = get_lexer_by_name(t)

        codeblock = highlight(codeblock, lexer, HtmlFormatter())
